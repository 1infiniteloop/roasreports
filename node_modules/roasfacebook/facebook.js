...
const User = (params) => {
    ...
    const profile_picture = {
        get: async (params) => {
            let { fb_user_id } = params;

            let picture_url = `https://graph.facebook.com/v12.0/${fb_user_id}/picture`;
            ...
            let { url: profile_picture_url } = response;
    ...
    const ad_accounts = {
        get: async (params) => {
            let func_name = "User:ad_accounts:get";
            ...
            let url = `https://graph.facebook.com/v12.0/${fb_user_id}/adaccounts`;
            ...
            let ad_accounts_response = await request(payload);

            return {
                type: "object",
                data: ad_accounts_response,
            };
        },
    };
